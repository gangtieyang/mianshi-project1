...
import com.yang.mianshi.mapper.QuestionMapper;
import com.yang.mianshi.model.dto.question.QuestionQueryRequest;
import com.yang.mianshi.model.entity.Question;
//import com.yang.mianshi.model.entity.QuestionFavour;
//import com.yang.mianshi.model.entity.QuestionThumb;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        String answer = questionQueryRequest.getAnswer(); //add
        // todo 补充需要的查询条件
        // 从多字段中搜索
        ...
        queryWrapper.like(StringUtils.isNotBlank(answer), "answer", answer); //add
        // JSON 数组查询
