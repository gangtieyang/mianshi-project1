...
import com.yang.mianshi.manager.CounterManager;
import com.yang.mianshi.model.dto.question.QuestionAddRequest;
import com.yang.mianshi.model.dto.question.QuestionEditRequest;
import com.yang.mianshi.model.dto.question.QuestionQueryRequest;
import com.yang.mianshi.model.dto.question.QuestionUpdateRequest;
...
import static com.yang.mianshi.constant.SentinelConstant.listQuestionVOByPage;
...
public class QuestionController {
     ...
     */
    @PostMapping("/add")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE) //只有管理員可以操作
     ...
     */
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE) //管理员才可以用
    ...
    /**
     * listQuestionVOByPageSentinel降级操作
     * @param questionQueryRequest
     * @param request
     * @param ex
     * @return
