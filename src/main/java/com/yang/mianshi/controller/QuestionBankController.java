...
import com.yang.mianshi.model.dto.questionBank.QuestionBankAddRequest;
...
public class QuestionBankController {
     ...
     */
    @PostMapping("/add")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE) //权限校验 只有管理員可以操作
     ...
     */
    @PostMapping("/update")
    @SaCheckRole(UserConstant.ADMIN_ROLE)    public BaseResponse<Boolean> updateQuestionBank(@RequestBody QuestionBankUpdateRequest questionBankUpdateRequest) {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        //设置本地缓存(如果不是热key，这个方法不会设置缓存  如果设置10次操作添加到缓存，那么第11放入缓存中，第12查询就在缓存里面查询)
