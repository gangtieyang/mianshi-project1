...
import com.yang.mianshi.model.dto.user.*;
...
public class UserController {
     ...
     */
    @PostMapping("/delete")
    @SaCheckRole(UserConstant.ADMIN_ROLE)    public BaseResponse<Boolean> deleteUser(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
